...
{
    internal class UpdateInstructorValidator : AbstractValidator<UpdateInstructorCommand>
    {
        #region Fields
        ...
        #region Constructors
        public UpdateInstructorValidator(IStringLocalizer<SharedResources> localizer,
